...
export class AddMoreFieldsToUserTable1702270424238 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`authStragety\` varchar(255) NOT NULL`);
    }
